// pages/find/taskjobDetails/taskjobDetails.js
var app = getApp();
    ...
    app.post('/projecttask/get',
      {
        ...
        console.log(res)
        var project = res.data.projectTask;
        ...
        app.post('/common/sysParam/getSysCode', {}).then((res) => {
          ...
          var taskJilUnitText = app.getCodeArrayText(res.data, 'SETTLEMENT_UNIT', project.taskJilUnit)
          that.setData({
