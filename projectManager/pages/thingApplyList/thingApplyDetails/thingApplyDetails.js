// pages/index/pages/thingApplyList/thingApplyDetails/thingApplyDetails.js
var app = getApp();
...
Page({
  ...
  onLoad: function (options) {
    ...
    // 获取计划申请详情信息
    app.post('/thingApply/get',
      {
        id: id,
      }).then((res) => {
        that.setData({
          checkData: res.data.apply,
  ...
  Reply: function (e) {
    ...
    // 添加批复/回复
    app.post('/thingApply/addReply',
      {
        id: targetId,
        content: inputValue,
        applyStatus: num,  // 申请状态(0 - 待审1 - 同意2 - 不同意)
        fileCode: file_code
      }).then((res) => {
        // 返回上一页要刷新
        prevPage.setData({
