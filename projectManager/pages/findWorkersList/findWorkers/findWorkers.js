...
Page({
  ...
  onLoad: function (options) {
    ...
    app.post('/project/get', {
      ...
      console.log(res)
      var cityId = res.data.project.cityId;
      var cityName = res.data.project.cityName;
      var address = res.data.project.address;
      var ob = {};
  ...
  formSubmit: function (e) {
    ...
    // 新增项目任务
    app.post('/projecttask/add', formData
    ).then((res) => {
      var id = res.data.taskId;
      wx.showModal({
        title: '提示',
        content: '发布成功',
        cancelText: '邀约',
